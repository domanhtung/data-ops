...
export function QualityTrustSection() {
  return (
    <section className="w-num-1920 flex flex-col items-center justify-center py-num-86 px-num-180 box-border relative isolate gap-12 max-w-full z-[4]">
      <Image
        className="w-num-1920 h-[1365.3px] absolute !m-0 top-[calc(50%_-_766.5px)] left-[calc(50%_-_960px)] object-contain z-[0] shrink-0"
        width={1920}
        height={1365}
        sizes="100vw"
        alt=""
      ...
      <section className="self-stretch flex flex-col items-center gap-6 z-[1] shrink-0 text-center text-[16px] text-text-sub-500 font-helvetica-now-display">
        ...
        <h2 className="m-0 self-stretch relative text-num-40 tracking-num--0_01 leading-num-48 font-medium font-[inherit] text-text-main-900">
          Where teams find the right experts
        </h2>
      </section>
      <div className="w-[1193px] h-[943px] flex items-start pt-[108px] px-num-0 pb-[91px] box-border relative isolate gap-[74px] max-w-full z-[1] shrink-0">
        <Image
          className="h-[345.3px] w-[460px] absolute !m-0 top-[calc(50%_-_180.5px)] left-[calc(50%_-_236.5px)] z-[2] object-cover"
          width={460}
          height={345}
          sizes="100vw"
          alt=""
        ...
        />
        <Image
          className="h-[78px] w-[156px] absolute !m-0 top-[539px] left-[805.5px] z-[1]"
          width={156}
          height={78}
          sizes="100vw"
          alt=""
        ...
        />
        <Image
          className="h-[78px] w-[156px] absolute !m-0 top-[539px] rotate-[50deg] left-[210px] object-contain z-[1]"
          width={156}
          height={78}
          sizes="100vw"
          alt=""
        ...
        />
        <Image
          className="h-[78px] w-[156px] absolute !m-0 top-[230px] rotate-[180deg] left-[694.5px] object-contain z-[1]"
          width={156}
          height={78}
          sizes="100vw"
          alt=""
        ...
        />
        <Image
          className="h-[78px] w-[156px] absolute !m-0 top-[230px] rotate-[50deg] left-[333px] z-[1]"
          width={156}
          height={78}
          sizes="100vw"
          alt=""
        ...
        />
        <Image
          className="h-[106px] w-[168px] absolute !m-0 top-[618px] left-[505.5px] object-contain z-[1]"
          loading="lazy"
          width={168}
          height={106}
          sizes="100vw"
