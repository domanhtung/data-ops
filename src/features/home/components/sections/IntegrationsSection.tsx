...
export function IntegrationsSection() {
  return (
    <section className="w-num-1920 flex flex-col items-center justify-center py-num-86 px-num-180 box-border gap-12 z-[8]">
      <Content
      ...
      />
      <section className="w-num-1024 rounded-num-16 flex items-center justify-center flex-wrap content-center gap-4">
